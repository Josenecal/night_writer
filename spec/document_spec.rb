...
RSpec.describe Document do
  ...
  before :each do
    @document = Document.from_nightwriter("the quick red fox jumped over the lazy brown dog")
  end
  ...
  it "scans for existing line breaks and reformats as arrays of paragraphs" do
    ...
    with_breaks = Document.from_nightwriter("the quick red fox jumped over the lazy brown dog\n\nthe lazy brown dog chased that fox all the way back to his den")
  ...
  it "breaks down several paragraphs into lines preserving paragraph breaks" do
    document = Document.from_nightwriter "This is an example of a long paragraph. I'm writing this specifically so that the first paragraph will need to be broken into several lines, and so that the last line will hopefully be left kind of stubby\n\nThis is the beginning of a second paragraph. I'm realizing that this test is long enough!"
